...
This repository contains the code, notebooks, and evaluation pipeline for a benchmark study of **ten recent machine learning algorithms** applied to **multi-class IoT network intrusion detection**, using the **TON-IoT** dataset as the primary benchmark. Additional datasets are included for the dataset-selection phase and for a traditional machine learning prototype.
